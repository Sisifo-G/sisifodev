...
<style>
  ...
  .Footer {
    ...
    display: grid;
    grid-template-areas:
      "datos-contacto redes footer-nav"
      "copy-area copy-area copy-area ";
  }
  .footer-nav {
    /* justify-self: center;
    align-self: center; */
...
<div class="Footer">
  ...
  <div class="datos-contacto">
    ...
    <div class="telefono">
      <div class="icono-contacto">
        <Phone {color} {size} {width} {height} {viewBox} />
      </div>
  ...
  <div class="copy">
    <p>
      ...
      <strong>
        <a href="http://www.sisifodev.com">SisifoDev.com</a>
      </strong>
      👍
    </p>
  </div>
